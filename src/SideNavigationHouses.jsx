            ...
            <div className="container-fluid">
                ...
                <div className="categories__popular">
                    ...
                    <div className="subCategories mt-3">
                        <ul className='firstList'>
                            ...
                            <li className='mb-2'>Property for Sale</li>
                        </ul>
                        <ul className='ml-2'>
                            <li className='mb-3 '>Land & Plots (24794)</li>
                            <li className='mb-3 boldMob'>Houses (15905)</li>
                            <li className='mb-3'>Apartments & Flats (5357)</li>
                            <li className='mb-3'>Shops - Offices - Commercial Space (3736)</li>
                ...
                <div className='condition_Heading'>
                    ...
                    <div className="inputCondition mt-3">
                        ...
                        <div className="label-container ml-2 mt-1">
                            <label htmlFor="">No <span>(10001)</span></label>
                        </div>
                    </div>
                    <div className="inputCondition">
                        <div className="checkbox-container">
                        ...
                        <div className="label-container ml-2 mt-1">
                            <label htmlFor="">Yes <span>(5897)</span></label>
                        </div>
                    </div>
                    </div>
                    <hr/>
...
export default SideNavigationHouses
