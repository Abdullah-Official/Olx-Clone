...
function CategDrop() {
    return (
        ...
        <nav class="navbar nav2 navbar-expand-lg navbar navbar-light " >
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item active">
                      <NavLink class="nav-link" to="/mobile">Mobile Phones </NavLink>
                    </li>
                    <li class="nav-item active">
                        <NavLink class="nav-link" to="/cars">Cars</NavLink>
                    </li>
                    <li class="nav-item active">
                        <NavLink class="nav-link" to="/motorcycles">Motorcycles</NavLink>
                    </li>
                    <li class="nav-item active">
                        <NavLink class="nav-link" to="/houses">Houses</NavLink>
                    </li>
                    <li class="nav-item active">
                        <NavLink class="nav-link" to="/tv-video-audio">TV-Video-Audio</NavLink>
                    </li>
                    <li class="nav-item active">
                        <NavLink class="nav-link" to="/tablets">Tablets</NavLink>
                    </li>
                    <li class="nav-item active">
                        <NavLink class="nav-link" to="/land-plots">Land & Plots</NavLink>
                    </li>
                </ul>
            </div>
        </nav>
