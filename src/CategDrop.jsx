      ...
      <>
        <div className="container-fluid mb-0 mt-0 mega__menu">
          <div class="container-fluid mainBotNav">
            <nav class="navbar nav2 navbar-expand-lg navbar navbarBot navbar-light ">
              <button
              ...
              <div class="collapse navbar-collapse collapse2" id="navbarNavDropdown">
                <ul class="navbar-nav">
                    ...
                    >
                      <div class="px-0 container">
                        <div class="row">
                          <div class="col-md-3">
                            <strong>
                              <small className="ml-3">Vehicles</small>
                            </strong>
                            ...
                            <div className="mt-3">
                              <strong>
                                <small className="ml-3">Mobiles</small>
                              </strong>
                              <a class="dropdown-item" href="#">
                                Mobile Phones
                              </a>
                          ...
                          <div class="col-md-3">
                            <strong>
                              <small className="ml-3">Animals</small>
                            </strong>
                            <a class="dropdown-item" href="#">
                              Other Animals
                            </a>
                            ...
                            <div className=" subMenu mt-3">
                              <strong>
                                <small className="ml-3 ">Furniture</small>
                              </strong>
                              <a class="dropdown-item" href="#">
                          ...
                          <div class="col-md-3">
                            <strong>
                              <small className="ml-3">Fashion & Beauty</small>
                            </strong>
                            <a class="dropdown-item" href="#">
                              Other Fashion
                            </a>
                            ...
                            <div className=" subMenu mt-3">
                              <strong>
                                <small className="ml-3 ">Property</small>
                              </strong>
                              <a class="dropdown-item" href="#">
                                Land & Plots
                              </a>
                              ...
                              <a class="dropdown-item" href="#">
                                Shops - Offices - Commerical Space
                              </a>
                              <a class="dropdown-item" href="#">
                                Portion & Floors
                              </a>
                          ...
                          <div className="col-md-3">
                            <strong>
                              <small className="ml-3">Services</small>
                            </strong>
                            <a class="dropdown-item" href="#">
                              Farm & Fresh Food
                            </a>
                  ...
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/mobile">
                      Mobile Phones{" "}
                    </NavLink>
                  </li>
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/cars">
                      Cars
                    </NavLink>
                  </li>
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/motorcycles">
                      Motorcycles
                    </NavLink>
                  </li>
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/houses">
                      Houses
                    </NavLink>
                  </li>
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/tv-video-audio">
                      TV-Video-Audio
                    </NavLink>
                  </li>
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/tablets">
                      Tablets
                    </NavLink>
                  </li>
                  <li class="nav-item active">
                    <NavLink class="nav-link" to="/land-plots">
                      Land & Plots
                    </NavLink>
                  </li>
                </ul>
