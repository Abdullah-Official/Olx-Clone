        ...
        <>
            <div className="footerMainContainer container-fluid">
                <section className='FooterContent'>
                    <div className="part1">
                    <ul className='list__footer mr-4'>
                            <strong  className=' headingFooter'>POPULAR CATEGORIES</strong>
                    ...
                    <div className="part2">
                    <ul className='list__footer mr-4'>
                            <strong  className=' headingFooter'>trending searches</strong>
                    ...
                    <div className="part3">
                    <ul className='list__footer mr-4'>
                            <strong  className=' headingFooter'>about us</strong>
                    ...
                    <div className="part4">
                    <ul className='list__footer mr-4'>
                            <strong  className=' headingFooter'>olx</strong>

                                 <li>help</li>
                                 <li>sitemap</li>
                                 <li>legal and privacy information</li>
                                 <q className='hideLi'>hidden</q>
                                 
                             </ul>
                            
                    </div>
                    <div className="part5 pb-3">
                    <strong  className=' headingFooter'>follow us</strong>
                    <div className="socialIcons">
                        <a href="#" className='social'>{fb}</a>
                        <a href="#" className='social'>{twitter}</a>
                        <a href="#" className='social'>{yt}</a>
                        <a href="#" className='social'>{insta}</a>
                    </div>
                    <div className="appIcons my-3">
                                <img className='img-fluid' src="https://statics.olx.com.pk/external/base/img/appstore_2x.png" alt="IOS"/>
...
{/* <div className="container-fluid footerMainContainer">
                <div className="col-md-7">
                    <div className="row">
                        <div className="col-md-4 p-3 col-sm-12">
                            <ul className='list__footer mr-4'>
                            <strong  className=' headingFooter'>POPULAR CATEGORIES</strong>
