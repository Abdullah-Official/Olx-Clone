...
<div className="afterIcons">
    <div className="chatIcon ml-4">
        {chatIcon}
    </div>
    <div className="bellIcon ml-4">
        {bellIcon}
    </div>
    <div className="AvatarIcon ml-2">
